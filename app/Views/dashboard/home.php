...
<body>
    ...
    <section class="features">
        <div class="feature">
            ...
            <h3>Easy Booking</h3>
            <p>Book your tickets in just a few clicks, anytime, anywhere.</p>
        </div>
        <div class="feature">
            <i class="fas fa-lock"></i>
            <h3>Secure Payments</h3>
            <p>Your transactions are protected with state-of-the-art security measures.</p>
        </div>
        <div class="feature">
            <i class="fas fa-bolt"></i>
            <h3>Instant Confirmation</h3>
            <p>Receive your e-tickets immediately after purchase.</p>
        </div>
    </section>
        ...
        <div class="match-list">
            <div class="match-card">
                ...
                <div class="match-info">
                    ...
                    <p><i class="fas fa-map-marker-alt"></i> <strong>Venue:</strong> <span>Stadion Maguwoharjo</span>
                    </p>
            ...
            <div class="match-card">
                <div class="team-logos">
                    <img src="/logo.png" alt="PSS Sleman" class="team-logo">
                    <span class="vs">VS</span>
                    <img src="/PERSEBAYA.png" alt="Persebaya Surabaya" class="team-logo">
                </div>
                <h3>PSS Sleman vs Persebaya Surabaya</h3>
                <div class="match-info">
                    <p><i class="far fa-calendar-alt"></i> <strong>Date:</strong> <span>November 12, 2024</span></p>
                    <p><i class="far fa-clock"></i> <strong>Time:</strong> <span>20:00</span></p>
                    <p><i class="fas fa-map-marker-alt"></i> <strong>Venue:</strong> <span>Stadion Maguwoharjo</span>
                    </p>
                    <p><i class="fas fa-tag"></i> <strong>Price:</strong> <span>IDR 115,000</span></p>
                </div>
                <a href="/login" class="btn btn-green">Get Tickets</a>
            </div>
            ...
            <div class="match-card">
                <div class="team-logos">
                    <img src="/logo.png" alt="PSS Sleman" class="team-logo">
                    <span class="vs">VS</span>
                    <img src="/PSSI.png" alt="PSIS Semarang" class="team-logo">
                </div>
                <h3>PSS Sleman vs PSIS Semarang</h3>
                <div class="match-info">
                    <p><i class="far fa-calendar-alt"></i> <strong>Date:</strong> <span>November 19, 2024</span></p>
                    <p><i class="far fa-clock"></i> <strong>Time:</strong> <span>19:00</span></p>
                    <p><i class="fas fa-map-marker-alt"></i> <strong>Venue:</strong> <span>Stadion Maguwoharjo</span>
                    </p>
                    <p><i class="fas fa-tag"></i> <strong>Price:</strong> <span>IDR 105,000</span></p>
                </div>
                <a href="/login" class="btn btn-green">Get Tickets</a>
            </div>
        </div>
        <div class="next-matches">
            <a href="#" class="btn btn-outline" id="nextMatchesBtn"><i class="fas fa-chevron-right"></i> Next
                Matches</a>
        </div>
    </section>
    ...
    <script>
        document.getElementById('buyNowBtn').addEventListener('click', function (e) {
            ...
            upcomingMatches.scrollIntoView({ behavior: 'smooth' });
        });

        document.getElementById('nextMatchesBtn').addEventListener('click', function (e) {
            e.preventDefault();
            alert('Loading more matches for PSS Sleman...');
        });
